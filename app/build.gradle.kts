...
dependencies {
    ...
    "amazonImplementation"("com.recurly:engage-sdk-android-amazon:2.3.5")
    "googleImplementation"("com.recurly:engage-sdk-android-google:2.3.5")
    "noiapImplementation"("com.recurly:engage-sdk-android-noiap:2.3.5")
    "coreImplementation"("com.recurly:engage-sdk-android-core:2.3.5")
